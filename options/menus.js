...
const menus = {
   ...
   'разное': {
      ...
      middle: [['Выбрать группу по Английскому Языку'], ["Добавить домашнее задание"], ['Работа с домашним заданием'], ['Назад']],
      junior: [['Выбрать группу по Английскому Языку'], ["Добавить домашнее задание"], ['Работа с домашним заданием'], ['Назад']],
      senjor: [['Выбрать группу по Английскому Языку'], ["Добавить домашнее задание"], ['Работа с домашним заданием'], ['Действия с админами'], ['Назад']]
   },
